    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle page-scroll" href="about.php" id="navbarDropdown" role="button"
                    aria-haspopup="true" aria-expanded="false">ABOUT</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="about.php"><span class="item-text">WHAT IS BOLSTER?</span></a>
                    <div class="dropdown-items-divide-hr"></div>
                    <a class="dropdown-item" href="who.php"><span class="item-text">LEADERSHIP</span></a>
                    <div class="dropdown-items-divide-hr"></div>
                    <a class="dropdown-item" href="what.php"><span class="item-text">WHAT WE OFFER?</span></a>
                    <div class="dropdown-items-divide-hr"></div>
                    <a class="dropdown-item" href="principal.php"><span class="item-text">PRINCIPAL'S MESSAGE</span></a>

                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="lifeatcampus.php">LIFE AT CAMPUS</a>
            </li>
